...
WORKER_MODE_DEDICATED_SERIE = "dedicated_series"
WORKER_MODES = [WORKER_MODE_GLOBAL, WORKER_MODE_DEDICATED_JOB_TYPE, WORKER_MODE_DEDICATED_SERIE]

class SerieConfigModel(ConfigModel):
    ...
    def __init__(self, worker_mode, dedicated_job_type=None, dedicated_series_name=None):
        ...
        if worker_mode == WORKER_MODE_DEDICATED_SERIE and dedicated_series_name is None:
            raise Exception("Invalid worker config")
